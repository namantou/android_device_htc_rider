...
ifeq (pac_rider,$(TARGET_PRODUCT))

# OVERLAY_TARGET adds overlay asset source
OVERLAY_TARGET := pa_hdpi

# AOKP device overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/pac/overlay/aokp/device/rider
...
$(call inherit-product, device/htc/rider/cm.mk)

PRODUCT_NAME := pac_rider
